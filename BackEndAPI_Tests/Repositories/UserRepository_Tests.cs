...
namespace BackEndAPI_Tests.Repositories
{
    [TestFixture]
    public class UserRepository_Tests
    {
        ...
        [Test]
        public async void GetAllUsers_Default_ShouldGetAllAvailableUsers()
        {
            //Arrange
            var options = new DbContextOptionsBuilder<AssetsManagementDBContext>()
                        .UseInMemoryDatabase(databaseName: "GetAllUsers_Default_ShouldGetAllAvailableUsers")
                        .Options;
